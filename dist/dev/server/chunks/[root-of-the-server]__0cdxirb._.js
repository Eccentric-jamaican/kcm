...
function isAppSubdomain(hostname) {
    return PLATFORM_HOSTS.has(hostname);
}
function isMarketingDomain(hostname) {
    return MARKETING_HOSTS.has(hostname);
}
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$server$2f$clerkMiddleware$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["clerkMiddleware"])((auth, request)=>{
    const hostname = getHostname(request);
    const { pathname } = request.nextUrl;
    if (isAppSubdomain(hostname)) {
        if (pathname === "/") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL("/app", request.url));
        }
        if (!pathname.startsWith("/app")) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL(`/app${pathname}`, request.url));
        }
    }
    if (isMarketingDomain(hostname) && pathname === "/app") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("https://app.kcmtrades.com/", request.url));
    }
    if (isMarketingDomain(hostname) && pathname.startsWith("/app/")) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL(`https://app.kcmtrades.com${pathname.slice("/app".length)}`, request.url));
    }
});
const config = {
    matcher: [
